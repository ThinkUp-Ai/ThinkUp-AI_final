...
const WEBHOOK_URL = import.meta.env.N8N_WEBHOOK_URL_dianahaftstein;

const ALLOWED_ORIGINS = [
  "https://wave2network.com",
  "https://www.wave2network.com",
  "https://www.naturheilkunde-rottweil.de",
  "https://naturheilkunde-rottweil.de",
  "https://thinkupai.de",
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    if (!WEBHOOK_URL) {
      console.error("N8N_WEBHOOK_URL_dianahaftstein is not set");
      return new Response(
    ...
    console.error("chatdianahaftstein error:", e);
    return new Response(
